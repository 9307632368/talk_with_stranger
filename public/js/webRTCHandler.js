...
peerConection.ondatachannel=(event)=>{
    ...
    dataChannel.onopen=()=>{    
    console.log('peer connection is ready to recive data channel message');
    };
...
peerConection.onicecandidate=(event)=>{
    ...
    if(event.candidate){
        //send our candiates to other peer
...
setIncomingCallsAvailable();
    ...
    if(preOfferAnswer=== constants.preOfferAnswer.CALL_UNAVAILABLE){
        ...
        //show dialog that callee is not connect
    }
    ...
    if(preOfferAnswer===constants.preOfferAnswer.CALL_REJECTED){
        ...
        //show dialog is rejected by callee
    }
...
export const handleWebRTCCandidate =async(data)=>{
    ...
    try {
        ...
        console.error("error occured when trying to add reiceved ice candidate",
        err
        );
    }
};
     ...
     const sender =senders.find((sender)=>{
      ...
      ui.updateLocalVideo(localStream); 
        ...
        ui.updateLocalVideo(screenSharingStream);
         ...
         console.error(
            'error occured when trying to get screen sharing stram',
            err
         );
        }
    }
...
export const hadleConnectedUserHangedUp =()=>{
    closePeerConnectionAndResetState();
};
